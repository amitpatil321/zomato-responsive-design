...
function App() {
  ...
  return (
    <div className="w-full h-screen">
          ...
          <div className="flex sm:flex-row flex-col items-center gap-4 sm:gap-0 bg-transparent sm:bg-white shadow-md rounded-lg w-[95%] lg:w-[50%]">
            <div className="flex items-center bg-white px-2 rounded-lg md:rounded-r-none w-full sm:w-[40%] h-14">
              ...
              <input
                ...
                className="flex-1 border-light-300 outline-none h-full text-gray-950 placeholder-gray-500"
              />
              <IoMdArrowDropdown className="ml-2 border-0 sm:border-r text-gray-500 text-2xl" />
            </div>

            <div className="flex items-center bg-white px-2 md:border-0 rounded-lg md:rounded-l-none w-full md:w-[60%] h-14">
              <CiSearch className="mr-2 text-gray-500 text-xl" />
              <input
                placeholder="Search for restaurant, cuisine or a dish"
                className="flex-1 outline-none h-full text-gray-950 placeholder-gray-500"
              />
            </div>
          </div>
        </div>
          ...
          {[
            ...
            >
              <div className="bottom-0 left-0 absolute bg-gradient-to-t from-black/90 via-black/70 to-transparent/20 px-3 py-4 rounded-b-lg w-full text-sm">
                <p className="font-thin text-light-200 text-base">
                  {item.title}
                </p>
                <p className="flex items-center gap-1 text-light-200">
      ...
      <div className="md:hidden flex mx-auto px-6 w-full md:w-3/5">
        <a
          href="#"
          className="flex items-center gap-1 text-primary-500 text-sm md:text-lg"
        >
          <span>All collections in Pune </span>
          <IoMdArrowDropright />
        </a>
                ...
                <div className="flex gap-2 mt-4">
                  {shareTarget === "email" ? (
                    <input
                      ...
                      placeholder="Email"
                      type="text"
                      className="px-4 border border-light-400 rounded-lg outline-none w-[65%] h-12"
                    />
                  ) : (
                    <div
                      id="phone"
                      className="flex justify-between items-center bg-white border border-light-400 rounded-lg w-[65%] h-12 overflow-hidden"
                    >
                      <input
                        name="country"
                        placeholder="Country"
                        type="text"
                        value="+91"
                        className="px-4 border-r border-light-400 outline-none w-[25%] h-8"
                      />
                      <input
                        name="phone"
                        placeholder="Phone"
                        type="text"
                        className="px-4 border-light-400 outline-none w-[75%] h-8"
                      />
                    </div>
                  )}
        ...
        <div className="mx-auto lg:w-3/5">
          ...
          <div className="gap-4 grid grid-cols-1 mt-4">
            {[
              ...
              return (
                <div className="flex justify-between items-center gap-2 bg-white shadow-sm px-6 py-4 border rounded-lg w-full">
                  <div>
        ...
        <div className="mx-auto lg:w-3/5">
          ...
          <div className="mt-8 pt-4 border-gray-300 border-t">
            <p className="text-gray-600 text-sm">
              ...
              are properties of their respective owners. 2008-2025 © Zomato™
